...
**设计哲学：**
MongoDB Design 强调数据驱动、开发者友好和可扩展性。设计风格注重用户体验，通过清晰的界面和直观的交互，帮助用户快速完成数据库管理和数据分析任务。色彩系统专业而不失活力，字体排版注重可读性和层次感，组件系统遵循原子设计原则，确保跨产品的一致性。
...
:root {
  ...
  --color-primary-hover: #00C752;
  --color-primary-active: #00A845;
  --color-primary-light: #33F085;
  --color-primary-lighter: #66F4A6;
  --color-primary-dark: #009E3D;
  --color-primary-darker: #007A30;
}
```
...
:root {
  ...
  --color-success-hover: #00C752;
  --color-success-light: #E6FFF0;
  --color-success-dark: #009E3D;
...
:root {
  ...
  /* 备用字体 */
  --font-family-fallback: 'PingFang SC', 'Microsoft YaHei', sans-serif;
...
**标题层级：**
- H1: 页面主标题，使用 32px，字重 600，行高 1.25
- H2: 章节标题，使用 24px，字重 600，行高 1.25
- H3: 小节标题，使用 20px，字重 600，行高 1.5
- H4: 卡片标题，使用 16px，字重 600，行高 1.5
- H5: 小标题，使用 14px，字重 500，行高 1.5
- H6: 副标题，使用 12px，字重 500，行高 1.5
...
--font-size-h2-tablet: 1.375rem;   /* 22px */
--font-size-h3-tablet: 1.125rem;   /* 18px */
--font-size-body-tablet: 0.9375rem; /* 15px */

/* 桌面端（> 1024px） */
--font-size-h1-desktop: 2rem;      /* 32px */
--font-size-h2-desktop: 1.5rem;    /* 24px */
--font-size-h3-desktop: 1.25rem;   /* 20px */
...
:root {
  ...
  --brand-primary-hover: #00C752;
  --brand-primary-active: #00A845;
  --brand-primary-light: #33F085;
  --brand-primary-lighter: #66F4A6;
  --brand-primary-dark: #009E3D;
  --brand-primary-darker: #007A30;

  /* Semantic Colors */
  --semantic-success: #00ED64;
  --semantic-success-hover: #00C752;
  --semantic-success-light: #E6FFF0;
  --semantic-success-dark: #009E3D;
...
*本设计系统文档基于 MongoDB Design 的设计原则和最佳实践整理，旨在帮助理解和学习现代设计系统的构建方法。*
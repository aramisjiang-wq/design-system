...
### 设计哲学
Linear Design System强调极简主义和高性能，通过极致简洁的设计语言和优雅的交互体验，为用户提供最佳的使用体验。设计风格偏向现代科技感，注重性能和速度，提供完整的组件库和设计规范。
...
:root {
  ...
  --color-primary-hover: #4B57C7;
  --color-primary-active: #3D47B8;
  --color-primary-light: #8B93E3;
  --color-primary-lighter: #B8BFF0;
  --color-primary-dark: #4B57C7;
  --color-primary-darker: #3D47B8;
}
```
...
:root {
  ...
  --color-blue-active: #1D4ED8;
  --color-blue-light: #DBEAFE;
  --color-blue-lighter: #BFDBFE;
  ...
  --color-green-active: #047857;
  --color-green-light: #D1FAE5;
  --color-green-lighter: #A7F3D0;
  ...
  --color-yellow-active: #B45309;
  --color-yellow-light: #FEF3C7;
  --color-yellow-lighter: #FDE68A;
  ...
  --color-pink-active: #BE185D;
  --color-pink-light: #FCE7F3;
  --color-pink-lighter: #FBCFE8;
  --color-pink-dark: #DB2777;
  --color-pink-darker: #BE185D;
}
```
...
#### 品牌元素（Brand Elements）
❌ **不应复刻**：
- **品牌Logo**：不应使用Linear的品牌Logo
- **品牌名称**：不应使用Linear的品牌名称
- **品牌口号**：不应使用Linear的品牌口号
- **品牌标识**：不应使用Linear的品牌标识

#### 插画内容（Illustration Content）
❌ **不应复刻**：
- **品牌插画**：不应使用Linear的品牌插画
- **人物插画**：不应使用Linear的人物插画
- **场景插画**：不应使用Linear的场景插画
- **装饰插画**：不应使用Linear的装饰插画

#### 具体内容（Specific Content）
❌ **不应复刻**：
- **文案内容**：不应直接复制Linear的文案内容
- **数据内容**：不应使用Linear的具体数据
- **案例内容**：不应使用Linear的客户案例
- **功能描述**：不应直接复制Linear的功能描述

#### 图标资源（Icon Resources）
❌ **不应复刻**：
- **品牌图标**：不应使用Linear的品牌图标
- **自定义图标**：不应使用Linear的自定义图标
- **图标组合**：不应直接复制Linear的图标组合

### 合法使用建议（Legal Usage Guidelines）

#### 设计系统使用（Design System Usage）
✅ **合法使用**：
- **学习设计原则**：可以学习Linear的设计原则和设计哲学
- **参考组件规范**：可以参考Linear的组件规范和交互模式
- **借鉴布局模式**：可以借鉴Linear的布局模式和响应式策略
- **使用Design Token**：可以使用类似Linear的Design Token命名规范

#### 实现建议（Implementation Suggestions）
✅ **建议实现**：
- **创建自己的颜色系统**：基于Linear的颜色系统逻辑，创建自己的颜色系统
- **设计自己的组件库**：参考Linear的组件规范，设计自己的组件库
- **建立自己的设计规范**：基于Linear的设计规范，建立自己的设计规范
- **开发自己的设计系统**：参考Linear的设计系统，开发自己的设计系统

#### 注意事项（Important Notes）
⚠️ **注意事项**：
- **避免直接复制**：避免直接复制Linear的设计元素和内容
- **保持原创性**：保持自己的设计原创性和品牌特色
- **尊重知识产权**：尊重Linear的知识产权和品牌权益

...
Adobe Spectrum 官方设计系统，Creative Cloud 设计规范

---

## 1. 设计风格总览（Design DNA）

**核心关键词**：专业、系统化、企业级、一致性、可扩展
...
**设计哲学**：
Adobe Spectrum 是 Adobe 官方设计系统，旨在为所有 Adobe 产品提供一致的用户体验。其设计理念强调专业性、系统性和可扩展性，通过统一的设计语言确保跨产品的一致性。Spectrum 注重功能性与美观性的平衡，以用户为中心，提供清晰、直观的交互体验。
...
```css
:root {
  /* Adobe Spectrum 品牌主色 - 蓝色系 */
  --color-primary: #1473E6;
  --color-primary-hover: #0D5BB8;
  --color-primary-active: #084A93;
  --color-primary-light: #4A9BF0;
  --color-primary-lighter: #78C2F5;
  --color-primary-dark: #0D5BB8;
  --color-primary-darker: #084A93;
  
  /* 辅助主色 - 紫色 */
  --color-secondary: #9D36E6;
  --color-secondary-hover: #7D2BB8;
  --color-secondary-active: #642293;
  --color-secondary-light: #B86BF0;
  --color-secondary-lighter: #D29BF5;
  --color-secondary-dark: #7D2BB8;
  --color-secondary-darker: #642293;
}
```

**使用场景**：
- 主色：用于主要操作按钮、导航高亮、重要链接
...
:root {
  ...
  --color-success-hover: #237555;
  --color-success-active: #1A5C42;
  --color-success-light: #5CB38A;
  --color-success-lighter: #8AD3A8;
  ...
  /* 错误色 - 红色 */
  --color-error: #D93025;
  --color-error-hover: #B92B20;
  --color-error-active: #9B261C;
  --color-error-light: #E85D54;
  --color-error-lighter: #F28B83;
...
**字体选择**：
- Source Sans Pro：Adobe 官方开源字体，用于正文和 UI 文本
- Source Code Pro：等宽字体，用于代码和技术内容
...
**排版规则**：
- 标题：使用较紧的行高（1.25-1.5）和较重的字重（600-700）
- 正文：使用标准行高（1.5）和常规字重（400-500）
- 说明文本：使用较松的行高（1.5-1.75）和轻字重（300-400）
...
:root {
  ...
  /* 图标颜色 */
  --icon-color-default: var(--color-gray-600);
  --icon-color-hover: var(--color-gray-800);
...
- 可以学习和参考设计系统的结构和方法论
- 可以使用相似的设计原则和最佳实践
- 不应直接复制 Adobe 的品牌元素和视觉资产
- 不应声称是 Adobe Spectrum 或与 Adobe 有官方关联
- 建议创建自己的品牌标识和视觉风格
- 确保所有设计元素都是原创或来自合法来源

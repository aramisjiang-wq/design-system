...
GitHub Primer 官方设计系统，开发者平台设计规范

---

## 1. 设计风格总览（Design DNA）

**核心关键词**：开发者友好、简洁、功能性强、一致性、可访问
...
**设计哲学**：
GitHub Primer 是 GitHub 的官方设计系统，专为开发者体验而设计。其设计理念强调功能性、简洁性和开发者友好性，通过清晰、直观的界面设计提升开发效率。Primer 注重可访问性和一致性，确保所有开发者都能轻松使用 GitHub 的产品和服务。设计风格偏向实用主义，避免过度装饰，专注于提供清晰的信息和高效的操作。
...
```css
:root {
  /* GitHub Primer 品牌主色 - 蓝色系 */
  --color-primary: #0969DA;
  --color-primary-hover: #085DC1;
  --color-primary-active: #0750A8;
  --color-primary-light: #54AEFF;
  --color-primary-lighter: #80CCFF;
  --color-primary-dark: #085DC1;
  --color-primary-darker: #0750A8;
  
  /* 辅助主色 - 绿色 */
  --color-secondary: #1A7F37;
  --color-secondary-hover: #156B2F;
  --color-secondary-active: #125826;
  --color-secondary-light: #2DA042;
  --color-secondary-lighter: #3FB950;
  --color-secondary-dark: #156B2F;
  --color-secondary-darker: #125826;
}
```

**使用场景**：
- 主色：用于主要操作按钮、链接、重要交互元素
- 辅助主色：用于成功状态、完成操作、积极反馈
...
:root {
  /* 中性色 - 灰色系 */
  --color-gray-000: #F6F8FA;
  --color-gray-100: #EAEFF2;
...
:root {
  ...
  --color-success-hover: #156B2F;
  --color-success-active: #125826;
  --color-success-light: #2DA042;
  --color-success-lighter: #3FB950;
  
  /* 警告色 - 黄色 */
  --color-warning: #9A6700;
  --color-warning-hover: #7D5500;
  --color-warning-active: #614400;
  --color-warning-light: #BF8700;
  --color-warning-lighter: #D4A72C;
  
  /* 错误色 - 红色 */
  --color-error: #CF222E;
  --color-error-hover: #B61B27;
  --color-error-active: #8C1A21;
  --color-error-light: #F85149;
  --color-error-lighter: #FF7B72;
  
  /* 信息色 - 蓝色 */
  --color-info: #0969DA;
  --color-info-hover: #085DC1;
  --color-info-active: #0750A8;
  --color-info-light: #54AEFF;
  --color-info-lighter: #80CCFF;
}
```
...
**字体选择**：
- 系统字体：使用系统默认字体，确保跨平台一致性和性能
- 等宽字体：用于代码和技术内容，确保代码可读性
...
:root {
  ...
  --container-width-medium: 1012px;
  --container-width-large: 1280px;
  --container-width-xlarge: 1400px;
}
```
...
- Mobile：< 768px
- Tablet：768px - 1012px
- Desktop：1012px - 1280px
- Large Desktop：1280px - 1400px
- Extra Large：> 1400px
...
:root {
  ...
  --color-brand-secondary: #1A7F37;
  
  /* 中性色 */
  --color-neutral-000: #F6F8FA;
  --color-neutral-100: #EAEFF2;
...
- 可以学习和参考设计系统的结构和方法论
- 可以使用相似的设计原则和最佳实践
- 不应直接复制 GitHub 的品牌元素和视觉资产
- 不应声称是 GitHub Primer 或与 GitHub 有官方关联
- 建议创建自己的品牌标识和视觉风格
- 确保所有设计元素都是原创或来自合法来源

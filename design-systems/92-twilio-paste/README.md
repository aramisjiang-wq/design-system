...
Twilio Paste 官方设计系统，通信平台设计规范

---

## 1. 设计风格总览（Design DNA）

**核心关键词**：通信、开发者友好、一致性、可访问、功能性
...
**设计哲学**：
Twilio Paste 是 Twilio 的官方设计系统，专为通信和开发者体验而设计。其设计理念强调功能性、一致性和开发者友好性，通过清晰、直观的界面设计提升开发效率和用户体验。Paste 注重可访问性和国际化，确保全球用户都能轻松使用 Twilio 的产品和服务。设计风格偏向实用主义，避免过度装饰，专注于提供清晰的信息和高效的操作。
...
```css
:root {
  /* Twilio Paste 品牌主色 - 红色系 */
  --color-primary: #F22F46;
  --color-primary-hover: #D9283D;
  --color-primary-active: #C02335;
  --color-primary-light: #F55C6E;
  --color-primary-lighter: #F88996;
  --color-primary-dark: #D9283D;
  --color-primary-darker: #C02335;
  
  /* 辅助主色 - 蓝色 */
  --color-secondary: #0C4C81;
  --color-secondary-hover: #0A3D6A;
  --color-secondary-active: #082E53;
  --color-secondary-light: #106BA3;
  --color-secondary-lighter: #148AC5;
  --color-secondary-dark: #0A3D6A;
  --color-secondary-darker: #082E53;
}
```
...
:root {
  ...
  --color-gray-300: #C1C9D2;
  --color-gray-400: #8891AA;
  --color-gray-500: #5E6C84;
  --color-gray-600: #445266;
  --color-gray-700: #364353;
  --color-gray-800: #1F2A36;
  --color-gray-900: #0B1623;
}
```
...
:root {
  /* 成功色 - 绿色 */
  --color-success: #337035;
  --color-success-hover: #295A2B;
  --color-success-active: #1F4520;
  --color-success-light: #4D8A4F;
  --color-success-lighter: #66A468;
  
  /* 警告色 - 黄色 */
  --color-warning: #996600;
  --color-warning-hover: #7A5200;
  --color-warning-active: #5C3D00;
  --color-warning-light: #B37F1A;
  --color-warning-lighter: #CC9933;
  
  /* 错误色 - 红色 */
  --color-error: #D9283D;
  --color-error-hover: #B61F31;
  --color-error-active: #931726;
  --color-error-light: #E54D5F;
  --color-error-lighter: #F07381;
  
  /* 信息色 - 蓝色 */
  --color-info: #0C4C81;
  --color-info-hover: #0A3D6A;
  --color-info-active: #082E53;
  --color-info-light: #106BA3;
  --color-info-lighter: #148AC5;
}
```
...
:root {
  /* 品牌色 */
  --color-brand-primary: #F22F46;
  --color-brand-secondary: #0C4C81;
  ...
  --color-neutral-400: #8891AA;
  --color-neutral-500: #5E6C84;
  --color-neutral-600: #445266;
  --color-neutral-700: #364353;
  --color-neutral-800: #1F2A36;
  --color-neutral-900: #0B1623;
  
  /* 语义色 */
  --color-semantic-success: #337035;
  --color-semantic-warning: #996600;
  --color-semantic-error: #D9283D;
  --color-semantic-info: #0C4C81;
}
```
...
- 可以学习和参考设计系统的结构和方法论
- 可以使用相似的设计原则和最佳实践
- 不应直接复制 Twilio 的品牌元素和视觉资产
- 不应声称是 Twilio Paste 或与 Twilio 有官方关联
- 建议创建自己的品牌标识和视觉风格
- 确保所有设计元素都是原创或来自合法来源

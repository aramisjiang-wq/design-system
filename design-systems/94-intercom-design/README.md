...
Intercom 官方设计系统，客户沟通平台设计规范

---

## 1. 设计风格总览（Design DNA）

**核心关键词**：沟通、友好、简洁、一致性、可访问
...
**设计哲学**：
Intercom Design 是 Intercom 的官方设计系统，专为客户沟通和客户服务而设计。其设计理念强调沟通的友好性、简洁性和一致性，通过清晰、直观的界面设计提升客户沟通效率和用户体验。Intercom Design 注重可访问性和国际化，确保全球用户都能轻松使用 Intercom 的产品和服务。设计风格偏向友好和实用主义，避免过度装饰，专注于提供清晰的信息和高效的操作。
...
```css
:root {
  /* Intercom Design 品牌主色 - 蓝色系 */
  --color-primary: #1F8DED;
  --color-primary-hover: #1A7BC9;
  --color-primary-active: #1669A5;
  --color-primary-light: #4AA3F1;
  --color-primary-lighter: #73B9F5;
  --color-primary-dark: #1A7BC9;
  --color-primary-darker: #1669A5;
  
  /* 辅助主色 - 绿色 */
  --color-secondary: #2F9F5B;
  --color-secondary-hover: #268049;
  --color-secondary-active: #1D6138;
  --color-secondary-light: #52B37A;
  --color-secondary-lighter: #75C799;
  --color-secondary-dark: #268049;
  --color-secondary-darker: #1D6138;
}
```
...
:root {
  ...
  --color-success-hover: #268049;
  --color-success-active: #1D6138;
  --color-success-light: #52B37A;
  --color-success-lighter: #75C799;
  ...
  /* 信息色 - 蓝色 */
  --color-info: #1F8DED;
  --color-info-hover: #1A7BC9;
  --color-info-active: #1669A5;
  --color-info-light: #4AA3F1;
  --color-info-lighter: #73B9F5;
}
```
...
:root {
  /* 品牌色 */
  --color-brand-primary: #1F8DED;
  --color-brand-secondary: #2F9F5B;
...
- 可以学习和参考设计系统的结构和方法论
- 可以使用相似的设计原则和最佳实践
- 不应直接复制 Intercom 的品牌元素和视觉资产
- 不应声称是 Intercom Design 或与 Intercom 有官方关联
- 建议创建自己的品牌标识和视觉风格
- 确保所有设计元素都是原创或来自合法来源

...
Help Scout 官方设计系统，客户支持工具设计规范

---

## 1. 设计风格总览（Design DNA）

**核心关键词**：支持、友好、简洁、一致性、可访问
...
**设计哲学**：
Help Scout Design 是 Help Scout 的官方设计系统，专为客户支持和客户服务而设计。其设计理念强调支持的友好性、简洁性和一致性，通过清晰、直观的界面设计提升客户支持效率和用户体验。Help Scout Design 注重可访问性和国际化，确保全球用户都能轻松使用 Help Scout 的产品和服务。设计风格偏向友好和实用主义，避免过度装饰，专注于提供清晰的信息和高效的操作。
...
```css
:root {
  /* Help Scout Design 品牌主色 - 蓝色系 */
  --color-primary: #1D9BF0;
  --color-primary-hover: #1A82CC;
  --color-primary-active: #1769A8;
  --color-primary-light: #4DB5F3;
  --color-primary-lighter: #7DCFF6;
  --color-primary-dark: #1A82CC;
  --color-primary-darker: #1769A8;
  
  /* 辅助主色 - 橙色 */
  --color-secondary: #FF8A00;
  --color-secondary-hover: #E67A00;
  --color-secondary-active: #CC6B00;
  --color-secondary-light: #FFA333;
  --color-secondary-lighter: #FFBD66;
  --color-secondary-dark: #E67A00;
  --color-secondary-darker: #CC6B00;
}
```
...
:root {
  ...
  /* 信息色 - 蓝色 */
  --color-info: #1D9BF0;
  --color-info-hover: #1A82CC;
  --color-info-active: #1769A8;
  --color-info-light: #4DB5F3;
  --color-info-lighter: #7DCFF6;
}
```
...
**品牌元素**：
- Help Scout 品牌标识和 Logo
- Help Scout Design 品牌名称
- Help Scout 官方插画和图标
- Help Scout 产品特定的视觉元素

**具体内容**：
- Help Scout 产品界面截图
- Help Scout 官方文档内容
- Help Scout 商标和版权材料
- Help Scout 特定的产品功能描述

**法律建议**：
- 可以学习和参考设计系统的结构和方法论
- 可以使用相似的设计原则和最佳实践
- 不应直接复制 Help Scout 的品牌元素和视觉资产
- 不应声称是 Help Scout Design 或与 Help Scout 有官方关联
- 建议创建自己的品牌标识和视觉风格
- 确保所有设计元素都是原创或来自合法来源
